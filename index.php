...
<!-- da -->
FROM `degrees`
<!-- aggiungere courses, ha un legame con degrees -->
JOIN `courses`
<!-- prendiamo le info -->
ON `degrees`.`id` = `courses`.`degree_id`<!-- dopo aver terminato la loro relazione -->
<!-- ricominciamo con un nuovo JOIN -->
JOIN `exams`
<!-- prendiamo le info -->
ON `exams`.`course_id` = `courses`.`id`

<!-- con questo abbiamo ottenuto id della prima tab, id della seconda tabella e id della terza tabella -->
